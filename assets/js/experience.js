...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/logo_customhouse.jpg",
    place: "Custom house Inc",
    time: "(October 2018 - Present)",
    desp: "<li>Worked to migrate Flipkart lite’s product page to AMP pages so that they load up instantly.</li> <li>Made changes in the current progressive web app of Flipkart to react to different actions performed on AMP page.</li> <li>Created a node module called “fk-amp” which abstracts all the files and middlewares and can be easily imported and used from express server.</li>",
  },
  {
    title: "Programmer Analyst",
    cardImage: "assets/images/experience-page/logo_simform.jpg",
    place: "Simform Solutions",
    time: "(April 2017 - September 2018)",
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/logo_simform.jpg",
    place: "Simform Solutions",
    time: "(September 2013 - March, 2017)",
    desp: "<li>Worked on the project “LTI (Learning Tools Interoperability) 2.0 standards Implementation for ekShiksha.</li><li>Designed a software that would help faculty to create a quiz using the questions from the database based on his/her choice of topics and he should be provided with various facilities and options to create a quiz of his choice.</li>",
  },
  {
    title: "Software Development Intern",
    cardImage: "assets/images/experience-page/logo_bodhaguru.jpg",
    place: "Bodhaguru Learning Private Limited",
    time: "(April, 2013 - July, 2013)",
    desp: "<li>Worked on the project “LTI (Learning Tools Interoperability) 2.0 standards Implementation for ekShiksha.</li><li>Designed a software that would help faculty to create a quiz using the questions from the database based on his/her choice of topics and he should be provided with various facilities and options to create a quiz of his choice.</li>",
  },
];
